...
const SECTIONS = [
  ...
  { id: 'facts', num: '03', title: 'Identity', sub: 'Legal, address & links' },
  { id: 'ai', num: '04', title: 'AI Engine', sub: 'Models & diagnostics' },
  { id: 'pairing', num: '05', title: 'Pairing', sub: 'Extension secret key' }
];
  ...
  return (
    <div className="bg-white dark:bg-black font-sans text-gray-900 dark:text-neutral-100 min-h-screen transition-colors duration-300">
      <div className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-20">
        ...
        {/* Main 8-col Architecture Split Grid */}
            ...
            <div className="p-6 sm:p-8 md:p-10 lg:p-12">
              ...
              <div className="pt-8 border-t border-gray-200 dark:border-neutral-800/80">
                ...
                <ul className="space-y-2 text-xs font-sans text-gray-500 dark:text-neutral-400">
                   ...
                   <li className="flex justify-between"><span>Knowledge Base</span> <span>{formData.knowledgeVault?.length || 0} stories</span></li>
                ...
                <div className="pb-32">
                    ...
                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="max-w-4xl">
                      <div className="flex justify-between items-end mb-12">
                        ...
                        <button onClick={() => setIsAddingKnowledge(true)} className="text-xs font-mono font-medium text-gray-900 dark:text-accent border-b border-transparent hover:border-gray-900 dark:hover:border-accent transition-colors flex items-center gap-2 pb-0.5 cursor-pointer">
                          <PlusIcon className="w-3.5 h-3.5" /> COMPOSE NEW
                        </button>
                      </div>
                      
                      <p className="text-lg font-sans font-light text-gray-600 dark:text-neutral-400 leading-relaxed mb-16 max-w-2xl">
                        Unstructured, free-form text about your experiences, goals, and technical deep-dives. Write naturally; the AI will parse and use this context when filling complex forms.
                      </p>
                      ...
                      {isAddingKnowledge && (
                        <div className="mb-16 p-8 border border-gray-200 dark:border-neutral-800">
                          ...
                          <form onSubmit={handleAddKnowledge} className="space-y-8">
                            <VaultInput label="Title / Topic" value={newKnowledge.title} onChange={e => setNewKnowledge({...newKnowledge, title: e.target.value})} placeholder="e.g., Scaling a database under load, or Relocation Preferences" />
                            <VaultInput type="textarea" label="Content (Natural Language)" value={newKnowledge.content} onChange={e => setNewKnowledge({...newKnowledge, content: e.target.value})} placeholder="Describe the situation, explain your preferences, or tell a story..." />
                  ...
                  {activeSection === 'custom' && (
                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="max-w-4xl">
                      ...
                      <p className="text-lg font-sans font-light text-gray-600 dark:text-neutral-400 leading-relaxed mb-16 max-w-2xl">
                        Simple, extensible key-value pairs for factual snippets you want the AI to remember exactly (e.g. `veteran_status`, `desired_salary`, `github_username`).
                      </p>
                      
                      <div className="mb-16 p-8 border border-gray-200 dark:border-neutral-800">
                        <h3 className="text-xl font-display font-light mb-8">Add Key-Value Fact</h3>
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-8">
                           <VaultInput label="Unique Key" value={newField.key} onChange={e => setNewField({...newField, key: e.target.value.toLowerCase().replace(/[^a-z0-9_]/g, '_')})} placeholder="e.g. veteran_status" />
                           <VaultInput label="Value" value={newField.value} onChange={e => setNewField({...newField, value: e.target.value})} placeholder="e.g. No" />
                        </div>
                  ...
                  {activeSection === 'facts' && (
                    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }} className="max-w-4xl">
                      ...
                      <p className="text-lg font-sans font-light text-gray-600 dark:text-neutral-400 leading-relaxed mb-16 max-w-2xl">
                        Your public portfolio profile acts as the main source of truth for public links and experience. Use this section for private overrides (e.g. Legal Name vs Public Name) required for job applications.
                      </p>
                      ...
                      <div className="space-y-16">
                        ...
                        <div className="pt-12 border-t border-gray-200 dark:border-neutral-800/80 grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-10">
                          ...
                          <VaultInput label="Alternate Phone" value={formData.personal.alternatePhone} onChange={e => setFormData({...formData, personal: {...formData.personal, alternatePhone: e.target.value}})} />
                        </div>
                      </div>
                    </motion.div>
                  )}
