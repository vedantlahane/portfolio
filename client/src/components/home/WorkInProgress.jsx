      ...
      {isMobile && (
        <>
          <AnimatePresence>
            {showPopup && (
              <motion.div
                className="fixed top-20 left-56 transform -translate-x-8 px-6 mx-0 py-3 bg-gradient-to-r from-slate-800/80 to-slate-800/20 backdrop-blur-sm rounded-4xl flex items-center shadow-lg"
