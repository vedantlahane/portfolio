...
const Footer = () => {
  ...
  <div className="px-6 sm:px-8 md:px-10 lg:px-12 xl:px-16 2xl:px-20 pb-4 sm:pb-6">
            ...
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="w-10 h-10 sm:w-8 sm:h-8 bg-gray-900 rounded flex items-center justify-center 
      ...
      <motion.button
        className="sm:hidden w-full py-4 bg-gray-100 text-gray-600 text-sm font-sans"
