        ...
        <section className="text-white py-20 min-h-screen flex items-center pt-36">
          <div className="container mx-auto px-4">
            ...
            <p className="max-w-2xl text-2xl font-medium mb-8 text-gray-300">
              on a journey to learn and build{" "}
              <span className="text-blue-400">innovative</span> software
              solutions, with a focus on crafting{" "}
              <span className="text-purple-400">dynamic</span> and{" "}
