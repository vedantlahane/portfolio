...
const HeroIntro = () => {
  ...
  const handleDownloadCV = useCallback(() => {
    try {
      ...
      window.open(
        'https://drive.google.com/file/d/1FF5VZ9P8ddZVfaUemFyWcIDwSeRO21WO/view?usp=sharing',
        '_blank',
        'noopener,noreferrer'
      );
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-xs sm:text-sm text-gray-400 font-mono font-light">01 &nbsp;&nbsp;HERO</p>
      </motion.div>
